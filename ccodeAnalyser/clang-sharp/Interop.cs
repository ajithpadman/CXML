...
namespace ClangSharp {
    ...
    internal class Interop {
        ...
        [DllImport(nativeLib, CallingConvention = convention, CharSet = charSet)]
        public static extern ClangString clang_getTypeSpelling(Interop.Type type);
        ...
        [DllImport(nativeLib, CallingConvention = convention, CharSet = charSet)]
        public static extern StorageClass clang_Cursor_getStorageClass(Cursor cursor);
        ...
        [DllImport(nativeLib, CallingConvention = convention, CharSet = charSet)]
        internal static extern long  clang_getNumElements(Type t);
